...
CREATE TABLE IF NOT EXISTS `workflow_approval_results` (
  ...
  `start_next_retry_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '流程发起下次重试时间',
  `start_processing_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '流程发起任务抢占时间',
  ...
  `apply_next_retry_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '业务结果应用下次重试时间',
  `apply_processing_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '业务结果应用任务抢占时间',
  `started_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT 'Workflow 实例开始时间',
  `finished_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT 'Workflow 实例结束时间',
  `applied_at` datetime NOT NULL DEFAULT '1970-01-01 00:00:00' COMMENT '业务结果应用完成时间',
